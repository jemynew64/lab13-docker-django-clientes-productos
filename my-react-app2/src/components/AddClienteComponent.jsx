...
export const AddClienteComponent = () => {
  ...
  const saveOrUpdatCliente = (e) => {
    ...
    if (id) {
      ClienteService.updateCliente(id, cliente)
        .then(() => {
          // Aquí no utilizamos 'response' porque no lo necesitamos
          console.log(cliente);
          navigate("/clientes");
        })
        .catch((error) => {
  ...
  useEffect(() => {
    if (id) {
      ClienteService.getClienteById(id)
        .then((res) => {
          // Renombramos a 'res' para evitar la advertencia de ESLint
  ...
  }, [id]); // Asegurarse de que 'id' esté en las dependencias
              ...
              <form>
                ...
                <div className="botones">
                  <button
                    ...
                    onClick={(e) => saveOrUpdatCliente(e)}
                  >
                    Guardar
                  </button>
